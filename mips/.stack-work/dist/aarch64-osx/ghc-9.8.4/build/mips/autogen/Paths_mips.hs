...
sysconfdir = "/Users/kasdejong/IdeaProjects/BSC-thesis-mips-hs/mips/.stack-work/install/aarch64-osx/f585b035de5ef31dbf138ca0cb58261c8f025cbc39068a9fb44a12e9afd404ff/9.8.4/etc"

getBinDir     = catchIO (getEnv "mips_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "mips_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "mips_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "mips_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "mips_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "mips_sysconfdir") (\_ -> return sysconfdir)
